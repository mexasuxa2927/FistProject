...
public class Click_item_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_click_item_page);
        ...
        botton  = findViewById(R.id.button_click_item);
            ...
            public void onClick(View view) {
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                  ...
                  public void onDataChange(@NonNull DataSnapshot snapshot) {
                      ...
                      item_number = (int) snapshot.getChildrenCount();
                      HashMap<String,String> hashMap = new HashMap<>();
                      hashMap.put("name",nameText.getText().toString());
                      hashMap.put("disc",discText.getText().toString());
